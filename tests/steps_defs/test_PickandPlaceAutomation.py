...
def robot_position_initialX(errorThreshold):
    ...
    assert round(abs(0.5761017203330994 - abs(positionRobot[0])),2) <= errorThreshold
...
def robot_position_initialY(errorThreshold):
    positionRobot = readSensor(1)
    assert round(abs(0.0021495665423572063 - abs(positionRobot[1])),2) <= errorThreshold
...
def robot_position_initialZ(errorThreshold):
    positionRobot = readSensor(1)
    assert round(abs(0.434011310338974 - abs(positionRobot[2])),2) <= errorThreshold
...
def box_positionAX(errorThreshold):
    ...
    if positionBoxInitial[0] == 'red':
        assert (round(abs(0.5500000541335124 - abs(positionBoxInitial[1])),2)<= errorThreshold)
    else:
        assert (round(abs(0.5500000541335124 - abs(positionBoxInitial[1])),2)<= errorThreshold)
...
def box_positionA(errorThreshold):
    positionBoxInitial= readSensor(2)
    if positionBoxInitial[0] == 'red':
        assert (round(abs(0.19999997215550022 - abs(positionBoxInitial[2])),2)<= errorThreshold)
    else:
        assert (round(abs(0.19999997215550022 - abs(positionBoxInitial[2])),2)<= errorThreshold)
...
def box_positionA(errorThreshold):
    positionBoxInitial= readSensor(2)
    if positionBoxInitial[0] == 'red':
        assert (round(abs(1.000000266368528 - abs(positionBoxInitial[3])),2)<= errorThreshold)
    else:
        assert (round(abs(1.000000266368528 - abs(positionBoxInitial[3])),2)<= errorThreshold)
...
def box_positionBX(errorThreshold):
    ...
    if positionBoxFinal[0] == 'red':
        assert (round(abs(abs(-0.3252519529197406) - abs(positionBoxFinal[1])), 2) <= errorThreshold)
    else:
        assert (round(abs(abs(0.31896505436911077) - abs(positionBoxFinal[1])), 2) <= errorThreshold)
...
def box_positionBY(errorThreshold):
    ...
    positionBoxFinal = readSensor(3)
    if positionBoxFinal[0] == 'red':
        assert (round(abs(abs(0.22059896163617632) - abs(positionBoxFinal[2])), 2) <= errorThreshold)
    else:
        assert (round(abs(abs(0.43548827869933354) - abs(positionBoxFinal[2])), 2) <= errorThreshold)
...
def box_positionBZ(errorThreshold):
    ...
    positionBoxFinal = readSensor(3)
    if positionBoxFinal[0] == 'red':
        assert (round(abs(abs(0.7675001885747819) - abs(positionBoxFinal[3])), 2) <= errorThreshold)
    else:
        assert (round(abs(abs(0.7683375216119632) - abs(positionBoxFinal[3])), 2) <= errorThreshold)
